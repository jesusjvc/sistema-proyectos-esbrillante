...
export const actualizarFechaEntrega = (slug, fechaEstimadaEntrega) => req('PUT', `/api/proyectos/${slug}/fecha-entrega`, { fechaEstimadaEntrega })
...
export const actualizarTareasMasivo = (slug, data) => req('POST', `/api/proyectos/${slug}/tareas/masivo`, data)
