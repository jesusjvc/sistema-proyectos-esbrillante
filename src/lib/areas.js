...
export const AREAS = [
  { valor: 'web', label: 'Web', color: 'bg-blue-100 text-blue-700' },
  { valor: 'diseno_grafico', label: 'Diseño Gráfico', color: 'bg-purple-100 text-purple-700' },
  { valor: 'redes_sociales', label: 'Redes Sociales', color: 'bg-pink-100 text-pink-700' },
]
